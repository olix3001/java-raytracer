...
public class TexturedTriangle extends Triangle {
    ...
    public TexturedTriangle(Vector3 position, Vector3 position2, Vector3 position3, Vector2 uv1, Vector2 uv2, Vector2 uv3, Color color, float reflectivity, float emission, float transparency, Material mtl) {
        super(position, position2, position3, color, reflectivity, emission, transparency);
        this.uv1 = uv1;
        this.uv2 = uv2;
        this.uv3 = uv3;
        this.mtl = mtl;
    ...
    public Color getTextureColor(Vector3 point) {
        ...
        return ImageUtils.TextureWithUV(this.mtl.getTexture(), uv);
    }
